...
# Run test with LD_LIBRARY_PATH
.PHONY: run-test
run-test: $(TEST_BIN) $(LIB_SHARED)
	@echo "Running DSM test with LD_LIBRARY_PATH set..."
	LD_LIBRARY_PATH=$(BIN_DIR):$$LD_LIBRARY_PATH $(TEST_BIN) 8080 10
...
help:
	...
	@echo "  run-test - Run test_dsm with LD_LIBRARY_PATH set"
